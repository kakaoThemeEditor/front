...
import { MV3EditorTable } from "@/components/table/MV3EditorTable";

interface MV3EditorProps {
...
export function MV3Editor({ themeValues, setThemeValues, isActive, setIsActive }: MV3EditorProps) {
  return (
