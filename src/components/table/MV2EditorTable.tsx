...
import { MainViewStyle2Theme } from "../kakaoScreens/MainViewStyle2/type";
    ...
    <div className="w-full text-[10px] xl:text-xs text-left">
      ...
      <EditTableRow number={1}>
        <EditTableInnerRow>
          ...
          <ColorInput
            value={themeValues["MainViewStyle-Primary"]["background-color"]}
      ...
      <EditTableRow number={2}>
        <EditTableInnerRow>
          ...
          <ColorInput
            value={themeValues["MainViewStyle-Primary"]["-ios-text-color"]}
        ...
        <EditTableInnerRow>
          ...
          <ColorInput
            value={themeValues["MainViewStyle-Primary"]["-ios-highlighted-text-color"]}
      ...
      <EditTableRow number={3}>
        <EditTableInnerRow>
          ...
          <ColorInput
            value={themeValues["MainViewStyle-Primary"]["-ios-description-text-color"]}
        ...
        <EditTableInnerRow>
          ...
          <ColorInput
            value={themeValues["MainViewStyle-Primary"]["-ios-description-highlighted-text-color"]}
            onChange={(value) =>
      ...
      <EditTableRow number={4}>
        <EditTableInnerRow>
          ...
          <ColorInput
            value={themeValues["SectionTitleStyle-Main"]["-ios-text-color"]}
        ...
        <EditTableInnerRow>
          ...
          <AlphaInput
            value={themeValues["SectionTitleStyle-Main"]["-ios-text-alpha"]}
      ...
      <EditTableRow number={5}>
        <EditTableInnerRow>
          ...
          <ColorInput
            value={themeValues["SectionTitleStyle-Main"]["border-color"]}
        ...
        <EditTableInnerRow>
          ...
          <AlphaInput
            value={themeValues["SectionTitleStyle-Main"]["border-alpha"]}
