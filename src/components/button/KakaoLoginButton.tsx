...
export const KakaoLoginButton: React.FC<KakaoLoginButtonProps> = ({ className, ...props }) => {
  return (
    <Button
      className={`
        relative w-full bg-kakao-yellow hover:bg-kakao-yellow/70 text-kakao-black
        flex items-center justify-center gap-2 font-medium
        ${className || ""}
      `}
      {...props}
    >
      <svg className="w-4 h-4" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <path
          fill="currentColor"
